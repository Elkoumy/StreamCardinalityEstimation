...
#distributions="right_skewed normal sorted left_skewed"
#distributions="normal sorted"
...
for app in $approachs; do
	...
	for alg in $algorithms; do
		...
		for t in $tps; do
			...
			/root/swagExperiment/flink-1.7.2/bin/flink run -p 32 -c ee.ut.cs.dsg.StreamCardinality.LatencyExperiment CardinalityBenchmarking-0.1-SNAPSHOT.jar $alg $app $input_data $t $d
...
python ./collecting_results.py $log_dir $out_dir
