...
public class HyperLogLogAggregationFunction implements AggregateFunction<Tuple3<Long, String, Long>, HyperLogLogAccumulator, Tuple3<Long,String,Long>> {
    ...
    public Tuple3<Long, String, Long> getResult(HyperLogLogAccumulator acc) {
